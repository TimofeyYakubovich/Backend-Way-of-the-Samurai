...
const jsonBodyMiddleware = express_1.default.json(); // Создадим этот промежуточный слой jsonBodyMiddleware путём вызова метода JSON у объекта Express
exports.app.use(jsonBodyMiddleware); // скажем нашему приложению использовать его, прежде чем отправлять request в обработчики
