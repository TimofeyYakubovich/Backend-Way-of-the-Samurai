...
import { CourseUpdateModel } from "../../src/models/CourseUpdateModal"
...
describe('/courses', () => {
    ...
    it(`should'nt create course with correct input data`, async () => {
        ...
        const data: CourseCreateModel = {title: ''} // типизируем то что оправляем бекенду
    ...
    it(`should create course with correct input data`, async () => {
        ...
        const data: CourseCreateModel = {title: 'it-incubator course'} // типизируем то что оправляем бекенду
        ...
        expect(createCourse1).toEqual({  // выполним проверку. Скажем, что созданный курс должен быть объектом
            id: expect.any(Number),     // id, которая является каким угодно числом
    ...
    it(`create one more course`, async () => {
        ...
        const data: CourseCreateModel = {title: 'it-incubator course 2'} // типизируем то что оправляем бекенду

        // const createResponse = await request(app) // response Запишем его в переменную createResponse
        const createResponse = await getRequest() // response Запишем его в переменную createResponse
        .post('/courses')
    ...
    expect(createCourse2).toEqual({  // выполним проверку. Скажем, что созданный курс должен быть объектом
        id: expect.any(Number),     // id, которая является каким угодно числом
    ...
    it(`should'nt updata course with in correct input data`, async () => {

        const data: CourseUpdateModel = {title: ''} // типизируем то что оправляем бекенду
    ...
    it(`should'nt updata course that not exist`, async () => {
        // await request(app) // response Запишем его в переменную createResponse
        await getRequest()
            .put('/courses/' + -100)
    ...
    it(`should updata course with correct input data`, async () => {

        const data: CourseUpdateModel = {title: 'good new title'} // типизируем то что оправляем бекенду
    ...
    it(' interesting should return 200 and empty array', async () => {
        await getRequest()
            .get('/interesting')
            .expect(HTTP_STATUSES.OK_200, [])
            // .expect(200, [
    ...
    it(' interesting ID should return 200 and empty array', async () => {
        await getRequest()
            .get('/interesting/4')
            .expect(HTTP_STATUSES.OK_200, {title: 'data by id:'})
    })

    it(' interesting books should return 200 and empty array', async () => {
        await getRequest()
            .get('/interesting/books')
            .expect(HTTP_STATUSES.OK_200, {title: 'it\'s books handler'})
            // .expect(HTTP_STATUSES.OK_200, [])
            // .expect(200, [
            //     {id: 1, title: 'front-end'},
            //     {id: 2, title: 'back-end'},
